...
function BudgetItem({ budget }) {
  const calculateProgressPerc = () => {
    ...
    // Handle invalid values for totalSpend and amount
    if (isNaN(totalSpent) || isNaN(amount) || amount <= 0) return 0;
  
    // Calculate percentage and clamp to max 100%
    const perc = (totalSpent / amount) * 100;
  ...
  return (
    <Link href={"/dashboard/expenses/" + budget?.id}>
      <div
        className="p-5 mb-60 border rounded-2xl
